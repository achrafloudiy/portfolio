...
(function( $ ){
	...
	/* ----------------------------------------------------------- */
		...
		$('.mu-skill-progress-bar').appear(function() {
		 	...
		 	$('.mu-sharepoint-bar').LineProgressbar({
				percentage: 95,
				triggerOnce: true
			});

			$('.mu-o365-bar').LineProgressbar({
				percentage: 90,
				triggerOnce: true
			});

			$('.mu-backend-bar').LineProgressbar({
				percentage: 90,
				triggerOnce: true
			});

			$('.mu-powershell-bar').LineProgressbar({
				percentage: 95,
				triggerOnce: true
			});

			$('.mu-branding-bar').LineProgressbar({
				percentage: 85,
				triggerOnce: true
			});
